// screens/PersonalityTestScreen.js
...
const PersonalityTestScreen = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get(`${API_URL}/api/questions/personality`, {
  ...
  const handleCompleteTest = async () => {
    ...
    try {
      ...
      // Burada sadece personality test sonuçlarını gönderiyoruz örnek olarak
